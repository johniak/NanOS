/*
 * Font8x16.cpp — the canonical public-domain IBM VGA 8x16 text font (256 glyphs x 16
 * scanlines, 1 byte per scanline, MSB = leftmost pixel). This is the crisp DOS/VGA
 * console font (the same glyphs as Linux CONFIG_FONT_8x16), not the doubled 8x8 variant.
 *
 * Source: spacerace/romfont IBM_VGA_8x16.bin, dumped from the IBM VGA BIOS ROM (PD).
 */
#include "Font8x16.h"

namespace kernel {

static const unsigned char kFont8x16[256][16] = {
...
const unsigned char* fontGlyph(unsigned char c) { return kFont8x16[c]; }
