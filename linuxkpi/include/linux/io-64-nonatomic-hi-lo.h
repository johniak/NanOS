/* linuxkpi/include/linux/io-64-nonatomic-hi-lo.h — 64-bit MMIO as two 32-bit accesses. x86_64
 * has native readq/writeq, so these forward to them (order is irrelevant on real 64-bit MMIO). */
#ifndef _LKPI_IO64_NONATOMIC_HI_LO_H
#define _LKPI_IO64_NONATOMIC_HI_LO_H
#include <linux/io.h>
#ifndef lo_hi_readq
