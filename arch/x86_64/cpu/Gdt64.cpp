...
void Gdt64::initialize() {
    ...
    // TSS @ 0x30. Point IST1 at this CPU's dedicated #DF stack so #DF always lands on solid
    // ground; mark "no I/O bitmap". rsp0 is filled by setKernelStack before the first trap.
    tss64.ist1 = (uint64_t) (dfStack + sizeof(dfStack));
    tss64.iomap_base = sizeof(Tss64);
    setTss((uint64_t) &tss64, sizeof(Tss64) - 1);
...
void Gdt64::setKernelStack(uint64_t rsp0) { tss64.rsp0 = rsp0; }
