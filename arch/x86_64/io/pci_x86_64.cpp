/*
 * pci_x86_64.cpp — x86_64 PCI configuration-space access (<arch/pci.h>), "configuration
 * mechanism #1": write a dword address to CONFIG_ADDRESS (0xCF8), read/write the dword
 * at CONFIG_DATA (0xCFC).
 *
 * Port I/O is identical in long mode, so this is a near-verbatim mirror of the i686
 * impl (arch/x86/io/pci_x86.cpp); the outl/inl instructions and the address layout are
 * unchanged.
 *
