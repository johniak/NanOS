...
- [ ] **Step 2..N:** iterate clusters; commit per cluster (the git history IS the campaign log, as with drm core). NEXT tier = the 45 missing headers, then incomplete-types / implicit-decls, then the link phase.
