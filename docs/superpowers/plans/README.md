...
| [Migracja ekosystemu → NanOS-labs](2026-07-12-ecosystem-forks-migration.md) | org NanOS-labs, ~27 repo (forki z przepisami w środku), `ports.manifest`+`bootstrap.sh`+`migrate-fork.sh`, `docs/ECOSYSTEM.md`, brama clean-room | ✅ **ZIELONA brama clean-room 2026-07-13**: 30/30 etapów + verify64 + 14/14 externals ze świeżych klonów orga; zgnilizna 15 portów NAPRAWIONA (root-causes w ECOSYSTEM.md); ogon: port przeglądarki na x86_64 |
| [Kasacja i686/32-bit](2026-07-13-i686-retirement.md) | x86_64 jedyną architekturą: delete arch/x86 + 32-bit image/userland/testy, collapse dual-arch Makefile, kontener bez i686-elf, SDK bez i686-nanos; netsurf = stub do follow-upu | ✅ **DONE 2026-07-13**: pełny verify64 + 14/14 externals + image64/-gl na slim-kontenerze, ARCH domyślnie x86_64 |
