...
| **C** (Q5) | SMP / prawdziwa równoległość (ACPI MADT, AP startup INIT-SIPI-SIPI, per-CPU, scheduler SMP, IPI TLB shootdown, **BKL → blokady drobnoziarniste**) | 🟡 | **QEMU ✅** (4 rdzenie, `verify64`: smoke-smp/speedup ~3-4×/stress/netstress); BKL wycofany, blokady per-podsystem walidowane gatami wyścigów; real-HW do czasu Della. `docs/en/x86_64.md` §5.2 |
