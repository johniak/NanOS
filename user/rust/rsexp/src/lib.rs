...
impl App {
    ...
    fn activate(&mut self) {
        ...
        match self.kinds[i] {
            ...
            _ => {
                // any file: hand it to the system "open" (macOS-style) — a .nxe runs, other types
                // launch in their app. nwui_open_file honours a per-file default-program override
                // (set in the Properties window) ahead of the per-extension association.
