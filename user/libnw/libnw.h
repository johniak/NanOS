/*
 * libnw.h — the nanowm client library: connect to the compositor (over the inherited pipe
 ...
 * shared library libnw.ndl (the user32/gdi32 of nanowm); clients import it by name.
 */
#ifndef LIBNW_H
#define LIBNW_H
