...
MI_SOURCES+= Framebuffer.o Font8x16.o
...
TEST_MODULES+= drivers/Framebuffer.cpp drivers/Font8x16.cpp
# lcov patterns selecting the modules whose coverage is gated (String is support).
COV_PATTERNS="*/RamBlockDevice.*" "*/DeviceManager.*" "*/Vfs.*" "*/ExtFilesystem.*" "*/Ext2Filesystem.*" "*/Ext4Filesystem.*" "*/SynthFs.*" "*/Syscall.*" "*/NxeLoader.*" "*/KeyDecoder.*" "*/Process.*" "*/Signal.*" "*/Framebuffer.*" "*/MultibootMmap.*" "*/FrameAllocator.*" "*/AddressSpace.*"
